# Visual Pipeline (Citra Asli + Grayscale + Filtering + ROI/Segmentasi + Histogram + Edge Detection + Morfologi) 
...
for category in categories:
    ...
    # Kita proses semua 200 foto per kategori
    for filename in os.listdir(path):
        ...
        # 2. Histogram Equalization (Kunci Akurasi!)
        equ = cv2.equalizeHist(gray)
        
        # 3. Edge Detection (Canny)
        edges = cv2.Canny(equ, 100, 200)
        
        # Simpan hasil untuk nanti dipajang di jurnal
